...
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8 COMMENT='Review detail information';
...
INSERT INTO `review_detail` VALUES (6,6,1,'It\'s a pitty they don\'t have large sizes','You wont believe it, my show size is 13 so it\'s impossible for me to get a new pa','Seba\'s',1),(116,116,1,'Got the job done','Got this tool for the purpose of installing test pipes on my 370Z. I dont have access to a lift so this tool made the job so much easier in the close quarter setting. LED light was great because I cant really hold a light in such tight spot. ','Rayster',NULL),(117,117,1,'Overall Very Satisfied','Not to spend to much time on this here but I\'ve got to say Ive had a few different hex drivers from different brands, this one is by far the most powerful ive seen so far.','ToolManTaylor',NULL);
