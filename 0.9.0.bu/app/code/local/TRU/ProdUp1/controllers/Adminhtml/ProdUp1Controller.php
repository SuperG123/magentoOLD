...
// get proper attribute set id
                                		...
                                		if($attriSet){
                                			//TODO: Build logic for choosing proper attribute set.
                                			switch($attriSet){
                                				case "all":
                                        ...
                                        if($productId) {
                                           ...
                                           // if($data[$i]['sku']){$newproduct->setData('sku',$data[$i]['sku']);}
												...
												//if($attributeSetId){$newproduct->setAttributeSetId($attributeSetId);}else{$newproduct->setAttributeSetId('all');}
												...
												//if($data[$i]['_product_websites']){$newproduct->setWebsiteIds($data[$i]['_product_websites']);} //check<--
